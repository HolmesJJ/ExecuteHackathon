package com.example.enactusapp.TTS.Config;
...
public class TTSConfig {
    ...
    // 离在线SDK用
    public TTSConfig(String appId, String appKey, String secretKey, TtsMode ttsMode,
    ...
    // 纯离线SDK用
    public TTSConfig(String appId, String appKey, String secretKey, String sn, TtsMode ttsMode,
                     Map<String, String> params, SpeechSynthesizerListener listener) {
